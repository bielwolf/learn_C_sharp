...
// List<string> listaDasBandas = new List<string>{"U2", "The Beatles", "Calcinha Preta"};
...
void AvaliarUmaBanda()
{
    ...
    else
    {
        ...
        Console.WriteLine("Pressione a tecla Enter para voltar o menu principal");
        Console.ReadKey();
        Console.Clear();
        ExibirOpcoesDoMenu();
...
void ExibirMedia()
{
    ...
    if (bandasRegistradas.ContainsKey(nomeBanda))
    {
        ...
        double mediaDaBanda = notasBandas.Average();
        Console.WriteLine($"A média da banda {nomeBanda}: {mediaDaBanda}");
        Thread.Sleep(2000);
        Console.Clear();
        ExibirOpcoesDoMenu();
    }
    ...
    {
        Console.WriteLine($"O nome da banda {nomeBanda} não foi encontrado!");
